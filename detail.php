...
<script type="text/javascript" src="https://www.yoursystemurl.org/beta/js/detail.js?2"></script>
<?php
if (isset($geojson))
   {
...
if (isloggedin())
   {
echo '<h2>Your Bike</h2>';
$content=wheremybike(100);
echo $content;
