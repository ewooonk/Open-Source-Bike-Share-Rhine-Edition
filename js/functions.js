...
function mapinit()
{
   ...
   var osmUrl='https://dev.{s}.tile.openstreetmap.fr/cyclosm/{z}/{x}/{y}.png';
   ...
   $.ajax({
      ...
      url: "command.php?action=userbikes"
         ...
         if (jsonobject.content!="")
            ...
            if (jsonobject.bikelocks[0]==0) $('#unlock').hide();
            if (jsonobject.bikelocks[0]!=0) $('#unlock').show()
