      ...
      <form class="container" id="step1">
       <h2><?php echo _('Step 1 - Confirm your phone number'); ?></h2>
         <div class="form-group">
            <label for="number" class="control-label"><?php echo _('Phone number:'); ?></label> <input type="text" name="number" id="number" class="form-control" placeholder="0612345678"/>
         </div>
...
<?php endif; ?>
         ...
         <div class="form-group">
            <label for="useremail"><?php echo _('@wur.nl or @local-company email:'); ?></label> <input type="text" name="useremail" id="useremail" class="form-control" placeholder="email@wur.nl" /></div>
            </div>
         <div class="form-group">
